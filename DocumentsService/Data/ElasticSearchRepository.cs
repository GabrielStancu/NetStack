...
public class ElasticSearchRepository : IElasticSearchRepository
{
    ...
    public ElasticSearchRepository(IElasticClient client, string indexName)
    {
        _client = client;
        _indexName = indexName;
    }

    public ElasticSearchRepository Index(string indexName)
    {
        _indexName = indexName;
        return this;
    }
    ...
    {
        var indexResponse = await _client.IndexAsync(document, idx =>
